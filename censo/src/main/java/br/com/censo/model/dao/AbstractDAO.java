package br.com.censo.model.dao;
...
public abstract class AbstractDAO<PK, T> implements Serializable {
	...
	/**
	 * Retorna a entidade pelo atributo �nico, ou seja, assumir� que h� apenas uma
	 * entidade com este atributo, retornando apenas um elemento.
	 *
	 * @param propertyName
	 *            nome do atributo
	 * @param propertyValue
